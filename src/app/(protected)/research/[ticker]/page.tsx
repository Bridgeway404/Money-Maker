  ...
  return (
    <div className="space-y-6">
      ...
      {!report && !generating ? (
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            {activeTab === 'news' && (
              <div>
                <h3 className="text-lg font-semibold text-zinc-100 mb-3">Recent News & Earnings</h3>
      ...
      <ChatPanel
        ...
        initialMessage={
          report
            ? `I've analyzed ${report.ticker} (${report.company_name}) and assigned it a score of ${report.score}/100. Ask me anything about this company, the research, or LEAPS strategy for this name.`
            : undefined
        }
      />
    </div>
